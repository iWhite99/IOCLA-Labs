...
08048330 <_init>:
 ...
 8048349:	e8 72 00 00 00       	call   80483c0 <.plt.got>
...
080484fd <check_string>:
 ...
 8048510:	8d 45 d4             	lea    eax,[ebp-0x2c] ; 2c = 44 -> 
 8048513:	50                   	push   eax
 ...
 8048526:	81 7d f4 50 52 30 4e 	cmp    DWORD PTR [ebp-0xc],0x4e305250 ; c=12 -> ebp - 12 = 0x4e305250 -> N0RP
